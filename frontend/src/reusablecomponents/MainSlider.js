...
//         beforeChange: (current, next) => {
//             setAnimating(true);
//             setTimeout(() => setAnimating(false), 1000); // Match the animation duration
//             setCurrentSlide(next);
//         },
//         afterChange: () => {
//             setAnimating(false);
...
//                         <p className="img-para">THE RIGHT MIND SET</p>
//                         <div className="auto-container">
//                             <div className={`content ${currentSlide === index ? 'zoom-in' : animating && 'zoom-out'}`}>
//                                 <div className={`big-title ${currentSlide === index ? 'zoom-in' : animating && 'zoom-out'}`}>
//                                     <h2>
//                                         <span className="ttl-font-family cap d-flex flex-wrap" style={{width:"50%"}}>
//                                             <i>
//                                                 <span className="primary-clr text-primary">{slide.title.split(',')[0]}</span>
...
//                                         </span>
//                                     </h2>
//                                     <p className={`banner-para mt-md-4 mt-1 ${currentSlide === index ? 'zoom-in' : animating && 'zoom-out'}`} style={{ color: "#01003e" }} dangerouslySetInnerHTML={{ __html: slide.description }}></p>
//                                 </div>
//                                 <div className="btns-box">
//                                     <a className="btn-one style2" href="/contact">
//                                         <span className="border-box"></span>
