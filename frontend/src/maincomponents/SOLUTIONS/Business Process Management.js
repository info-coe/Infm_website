  ...
  return (
    <div>
      ...
      <div className="pt-5 pb-5">
        <AboutZoomin
          heading1={BPMData.BPM_Heading1}
          heading2={BPMData.BPM_Heading2}
          content={BPMData.content}
        />
      </div>
      ...
      <div
        style={{
          backgroundImage: `url(${BPMData.BPM_bgImg})`,
        ...
        >
          ...
          <div className="col-lg-6">
            {BPMData.BPM_Suites.map((item, index) => (
              <p key={index}>
                <span className="fw-bold">{item.name}</span>&nbsp;{item.desc}
              </p>
            ))}
          </div>
        </div>
